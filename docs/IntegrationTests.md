...
* Manually run the [manga updates integration tests](../bijutsu/src/test/java/com/ameerdev/metadata_provider/mangaupdates/MangaUpdatesMetadataProviderIntegrationTest.java) which
